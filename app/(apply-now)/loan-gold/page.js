...
export default function Home() {
  return (
    <>
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Loan Gold">
        <div>
              ...
              <div className="row">
                ...
                <div className="col-xl-4 col-lg-4">
                  <div className="single-applying-process-box">
                    ...
                    <h3>Apply Here</h3>
                    <p>
                      Perfectly simple & easy to distinguish of choice is
                      prevents.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-xl-4 col-lg-4">
                  <div className="single-applying-process-box">
                    ...
                    <h3>Get Call Back</h3>
                    <p>
                      Claims off duty or the obligations it will pleasures be
                      repudiated.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-xl-4 col-lg-4">
                  <div className="single-applying-process-box">
                    ...
                    <p>
                      Demoralized by charms pleasure of the they cannot and
                      trouble.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-xl-12">
                  <div className="apply-form-box clearfix">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url(assets/images/resources/apply-form-box-bg.jpg)",
                      }}
                    ></div>
