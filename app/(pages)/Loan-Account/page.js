...
export default function LoanAccount() {
  ...
  if (loading) {
    return (
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Loan Account">
  ...
  if (menuItems.length === 0) {
    return (
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Loan Account">
        <div className="container text-center py-5">
          <p>No loan types available at this time.</p>
        </div>
      </Layout>
    );
  }
  ...
  return (
    <Layout
      headerStyle={1}
      footerStyle={1}
      breadcrumbTitle={pageContent.breadcrumbTitle || "Loan Account"}
      breadcrumbSubTitle={pageContent.breadcrumbSubTitle || ""}
      backgroundImage={pageContent.bannerImage ? getImageUrl(pageContent.bannerImage) : "/assets/images/backgrounds/Loan-Banner.png"}
    >
