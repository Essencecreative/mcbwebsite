...
export default function Loans() {
  ...
  if (loading) {
    return (
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Loans">
  ...
  return (
    <Layout
      headerStyle={1}
      footerStyle={1}
      breadcrumbTitle={pageContent.breadcrumbTitle || "Loans"}
      breadcrumbSubTitle={pageContent.breadcrumbSubTitle || ""}
      backgroundImage={pageContent.bannerImage ? getImageUrl(pageContent.bannerImage) : "/assets/images/backgrounds/business-loan.png"}
    >
