...
export default function Invest() {
  ...
  if (loading) {
    return (
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Invest">
  ...
  if (menuItems.length === 0) {
    return (
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Invest">
        <div className="container text-center py-5">
          <p>No investment options available at this time.</p>
        </div>
      </Layout>
    );
  }
  ...
  return (
    <Layout
      headerStyle={1}
      footerStyle={1}
      breadcrumbTitle={pageContent.breadcrumbTitle || "Invest"}
      breadcrumbSubTitle={pageContent.breadcrumbSubTitle || ""}
      backgroundImage={pageContent.bannerImage ? getImageUrl(pageContent.bannerImage) : "/assets/images/backgrounds/Invest-Banner.png"}
    >
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-xl-9" ref={contentRef}>
              <div className="cards-content-box">
                <div className="account-content">
                  ...
                  {/* Render accordion items as regular content (not as accordions) */}
            ...
            <ApplyForm
              ...
              selectPlaceholder="Investment Type"
