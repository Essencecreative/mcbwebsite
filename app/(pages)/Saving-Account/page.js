...
export default function SavingsAccount() {
  ...
  if (menuItems.length === 0) {
    return (
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Savings Account">
        <div className="container text-center py-5">
          <p>No account types available at this time.</p>
        </div>
      </Layout>
    );
  }
  ...
  return (
    <Layout
      headerStyle={1}
      footerStyle={1}
      breadcrumbTitle={pageContent.breadcrumbTitle || "Savings Account"}
      breadcrumbSubTitle={pageContent.breadcrumbSubTitle || ""}
      backgroundImage={pageContent.bannerImage ? getImageUrl(pageContent.bannerImage) : "/assets/images/backgrounds/Savings-Banner.png"}
    >
