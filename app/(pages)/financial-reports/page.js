...
export default function FinancialReports() {
    ...
    useEffect(() => {
        const fetchItems = async () => {
            try {
                setLoading(true)
                const data = await getInvestorCategories('financial-reports', currentPage, 9)
                setItems(data.items || [])
    ...
    return (
        <>
            <Layout backgroundImage="/assets/images/backgrounds/Investor-Banner.png" headerStyle={1} footerStyle={1} breadcrumbTitle="Financial Reports" breadcrumbSubTitle="Financial Reports" breadcrumbLink="/financial-reports">
                <div>
                    {/*Blog Page Start*/}
